...
#ifndef FTK_FTK_UI_BACKEND_VULKAN_STORAGE_ZINDEX_HPP
#define FTK_FTK_UI_BACKEND_VULKAN_STORAGE_ZINDEX_HPP

namespace ftk { namespace ui {

// template <typename Z, std::size_t MinimumSizePerBuffer = 100 /* to avoid relocations */>
// struct storage_zindex
// {
...
//   Z create_zindex () // returns offset
//   {
