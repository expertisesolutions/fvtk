...
int main()
{
  ...
  win = XCreateWindow(dpy, root, 0, 0, 600, 600, 0, /*vi->depth*/24, InputOutput, /*vi->visual*/0, CWColormap | CWEventMask, &swa);
  ...
  std::optional<int> graphicsFamilyIndex, presentationFamilyIndex;
